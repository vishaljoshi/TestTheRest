...
//  console.log("drop");
  ...
  var getNode = function(name, type, id) {
    ...
    var _tmp = $doc.createElement("span");
    _tmp.innerHTML='<i class="icon-leaf">' + type + '</i>';
    ...
    if ('test' === type) {
      _tmp.draggable=true;
      _tmp.ondragstart=drag;
    }else if ('test suit' === type) {
      _tmp.ondrop=drop;
      _tmp.ondragover=allowDrop;
    }
    _li.appendChild(_tmp);
